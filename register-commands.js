...
const commands = [
  ...
  new SlashCommandBuilder().setName('traitfind').setDescription('Find sales or listings by trait — e.g. zombie, gold chain listings').addStringOption(o=>o.setName('search').setDescription('Trait + optional mode/count — leave blank to browse available traits').setRequired(false)).addStringOption(o=>o.setName('collection').setDescription('Collection slug').setRequired(false).setAutocomplete(true)),
