...
const commands = [
  ...
  new SlashCommandBuilder().setName('traitfind').setDescription('Find tokens, listings, or sales by trait').addStringOption(o=>o.setName('trait').setDescription('Trait name (e.g. Emotion, Type, Clothes)').setRequired(false).setAutocomplete(true)).addStringOption(o=>o.setName('value').setDescription('Trait value (e.g. Sadness, Zombie, Gold Chain)').setRequired(false).setAutocomplete(true)).addStringOption(o=>o.setName('mode').setDescription('What to search (default: tokens)').setRequired(false).addChoices({name:'Tokens',value:'tokens'},{name:'Listings',value:'listings'},{name:'Sales',value:'sales'})).addIntegerOption(o=>o.setName('count').setDescription('Number of results (default 20, max 50)').setRequired(false).setMinValue(1).setMaxValue(50)).addStringOption(o=>o.setName('collection').setDescription('Collection slug').setRequired(false).setAutocomplete(true)),
