...
async function buildListingEmbed(listing, config){
  ...
  // Fetch local trait/rank metadata for any collection with local trait
  // data, not just OCAS — fetchTokenMetaFromDb already supports any slug
  // via its own API call, it just was never being passed one here.
