  ...
  for (const t of transfers) {
    ...
    try {
      ...
      const result = await pgPool.query(
        `INSERT INTO nft_transfers (token_id, from_address, to_address, value_eth, block_number, transferred_at, tx_hash, collection_slug, contract)
        ...
        [t.tokenId, t.from, t.to, t.valueEth || 0, t.blockNum, t.timestamp, hash, slug, contract]
      );
