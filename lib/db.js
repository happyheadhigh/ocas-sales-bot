...
const pgPool = new Pool({
  ...
  idleTimeoutMillis: 10000,         // recycle idle connections faster (Railway drops them anyway)
  connectionTimeoutMillis: 4000,    // fail fast if pool is exhausted — don't hold Discord open
  statement_timeout: 8000,          // kill any hung query after 8s — prevents slot exhaustion
