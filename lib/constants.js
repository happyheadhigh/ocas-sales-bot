...
const BURN_BLOCK_CHUNK      = parseInt(process.env.BURN_BLOCK_CHUNK || '2000', 10);

// ── Rank sync ─────────────────────────────────────────────────────────────────
const RANK_SYNC_DELAY_MS = 45_000;
const RANK_SYNC_BATCH    = 50;
const RANK_SYNC_INTERVAL = 3600_000 / RANK_SYNC_BATCH * 1000;
...
module.exports = {
  DISCORD_TOKEN, OPENSEA_KEY, ALCHEMY_KEY, API_SECRET, ERROR_WEBHOOK_URL,
  BOT_ENV, POLL_MS, SERVER_FILE, ALERTS_FILE,
  RAILWAY_API_URL_CACHED, getRailwayApiUrl,
  COLORS, OCAS_CONTRACT, BURN_CONTRACT, BURN_START_BLOCK,
