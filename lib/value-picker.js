...
// Parses a `vpick:<customIdPrefix>:sel:<menuIndex>` or `vpick:<prefix>:done`
// customId. Prefix itself may contain ':' (callers embed their own
// multi-part context in it), so the action/index suffix is parsed from the
// right, not the left.
