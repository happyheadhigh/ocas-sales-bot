...
const { COLORS, OPENSEA_KEY, osHeaders } = require('./constants');
const { pgPool, getConfig, getUserAlerts, setUserAlerts } = require('./db');
const { getSaleCursor, saveSaleCursor } = require('./db');
const { sendErrorWebhook } = require('./error');
const { alertedEventIds, dedupeChannelPost } = require('./cache');
const { buildSaleEmbed, buildListingEmbed } = require('./embeds');
...
module.exports = {
  pollSales, pollListings, sendPersonalAlerts,
