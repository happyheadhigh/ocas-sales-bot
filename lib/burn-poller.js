...
async function buildBurnEmbed(finalEvent, startEvent, overrideTraits = null){
  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      ...
      ...(survivorPreBurnType ? [{ name:'Survivor', value:`#${survivorId} · was ${survivorPreBurnType} → now ${isAngel ? 'Angel' : normalizeOcasType(E1_TYPE_NAMES[bodyType]) || 'Unknown'}`, inline:false }] : []),
    );
