...
async function backfillCollectionTraits(pgPool, { contract, slug, chain = 'ethereum', totalSupply = null }){
  ...
  const supplyCeiling = totalSupply ? totalSupply + 10 : 20000; // small buffer past known supply; generous fixed ceiling if supply wasn't provided
  let rangeStart = 0;
  let totalFetched = 0;
...
module.exports = { backfillCollectionTraits, SUPPORTED_CHAINS, fetchTokenUriMetadata };
