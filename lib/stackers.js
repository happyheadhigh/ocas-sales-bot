...
// Engine and vault migrated Aug 17 2026 -- confirmed directly against
// Stackers' own docs page (a fresh, non-cached fetch, after an earlier
// cached fetch of the same page gave a stale, now-retired address that
// caused real confusion for a while). Previous engine (live Aug 10-17):
// 0xB0CC447d9aCE8aFB9AC4dae763afcf911c7E5CdA -- now explicitly retired
// per their docs, kept here only for reference, not in use.
const ENGINE_ADDRESS = '0xca32351c41D6CbBD84353FEC7d0438BBb869364A';
const VAULT_ADDRESS  = '0xBa5DB450613420AA3D8Dfbf963523f9C87A2aA48';
